...
Awesome Embodied RSI is curated rather than exhaustive. Core entries should demonstrate persistent embodied self-improvement (L2–L4). L0–L1 work is accepted only when it provides an important foundation, benchmark, or enabling mechanism.

## Inclusion checklist

- Use a primary source: paper, official project page, official repository, or official lab/company announcement.
- Explain what persists across episodes: model, policy, memory, skill, harness, embodiment, or improvement process.
- Assign the RSI level directly supported by evidence.
...
Open a resource suggestion issue or submit a pull request. Include:

- The title and primary-source URL.
